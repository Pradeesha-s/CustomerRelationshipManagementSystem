...
- Run Integration Tests:  
  Right-click on the integration test class (e.g., `CrmIntegrationTest`) in `src/test/java/com.Pradeesha.crm.integration` → **Run As → Maven Test**.  
