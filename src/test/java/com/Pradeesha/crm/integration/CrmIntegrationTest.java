package com.Pradeesha.crm.integration;
...
class CrmIntegrationTest {
        ...
        void fullCrmWorkflowTest() throws Exception {
                ...
                Customer c1 = new Customer(null, "Pradeesha", "Pradeesha@example.com", "9876543210", "Pune",
                                LocalDate.now());
                Customer c2 = new Customer(null, "Sharika Kr", "sharika@example.com", "9123456780", "Bangalore",
                                LocalDate.now());
                Customer c3 = new Customer(null, "Swizal Janice", "swizal@example.com", "9988776655", "Delhi",
                                LocalDate.now());
                ...
                createReport(new Report(null, "Sales Report - Pradeesha", "Summary of Pradeesha's sales",
                                LocalDate.now()));
