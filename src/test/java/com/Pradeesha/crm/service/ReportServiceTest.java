...
import com.Pradeesha.crm.dao.ReportRepository;
import com.Pradeesha.crm.entities.Report;
import com.Pradeesha.crm.service.ReportService;
...
class ReportServiceTest {
    ...
    void setUp() {
        ...
        report2 = new Report();
        report2.setId(2L);
        report2.setReportName("Pradeesha Patil Interaction Report");
        report2.setDescription("All interactions with Pradeesha Patil during Q3 2024.");
    ...
    void testGetReportById_Found() {
        ...
        assertNotNull(found);
        assertEquals("Pradeesha Patil Interaction Report", found.getReportName());
    }
    ...
    void testUpdateReport_Found() {
        ...
        assertEquals("Pradeesha Patil Interaction Report", updated.getReportName());
    }
