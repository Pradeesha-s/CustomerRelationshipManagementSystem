...
import com.Pradeesha.crm.dao.InteractionsRepository;
import com.Pradeesha.crm.entities.Interactions;
import com.Pradeesha.crm.service.InteractionsService;
...
class InteractionsServiceTest {
    ...
    void setUp() {
        ...
        interaction2.setNotes("Sent proposal to Pradeesha Patil for premium plan.");
    ...
    void testGetInteractionById_Found() {
        ...
        assertTrue(found.getNotes().contains("Pradeesha Patil"));
    }
    ...
    void testUpdateInteraction_Found() {
        ...
        assertTrue(updated.getNotes().contains("Pradeesha Patil"));
    }
