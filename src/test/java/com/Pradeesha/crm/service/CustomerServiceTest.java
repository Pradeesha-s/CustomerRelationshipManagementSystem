package com.Pradeesha.crm.service;

import com.Pradeesha.crm.dao.CustomerRepository;
import com.Pradeesha.crm.entities.Customer;
import com.Pradeesha.crm.service.CustomerService;
...
class CustomerServiceTest {
    ...
    void setUp() {
        ...
        customer2.setId(2L);
        customer2.setName("Pradeesha Patil");
        customer2.setEmail("Pradeesha.patil@example.com");
    ...
    void testGetCustomerById_Found() {
        ...
        assertNotNull(found);
        assertEquals("Pradeesha Patil", found.getName());
        assertEquals("Pradeesha.patil@example.com", found.getEmail());
    }
    ...
    void testUpdateCustomer_Found() {
        ...
        assertEquals("Pradeesha Patil", updated.getName());
        assertEquals("Pradeesha.patil@example.com", updated.getEmail());
    }
