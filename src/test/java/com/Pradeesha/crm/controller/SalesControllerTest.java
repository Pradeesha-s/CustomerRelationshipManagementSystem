package com.Pradeesha.crm.controller;

import com.Pradeesha.crm.controller.SalesController;
import com.Pradeesha.crm.entities.Customer;
import com.Pradeesha.crm.entities.Sales;
import com.Pradeesha.crm.service.SalesService;
...
class SalesControllerTest {
    ...
    void setUp() {
        ...
        customer2.setName("Pradeesha");
        customer2.setEmail("Pradeesha@example.com");
    ...
    void testGetAllSales() {
        ...
        assertTrue(result.stream().anyMatch(s -> s.getCustomer().getName().equals("Pradeesha")));
    ...
    void testGetSaleById_Found() {
        ...
        assertEquals("Pradeesha", result.getCustomer().getName());
