...
import com.Pradeesha.crm.controller.InteractionsController;
...
public class InteractionsControllerTest {
    ...
    void setUp() {
        ...
        interaction1.setNotes("Discussed requirements with Pradeesha");
    ...
    void testAddInteraction() {
        ...
        assertTrue(result.getNotes().contains("Pradeesha"));
    }
