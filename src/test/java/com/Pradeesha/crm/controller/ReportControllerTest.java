...
import com.Pradeesha.crm.controller.ReportController;
...
public class ReportControllerTest {
    ...
    void setUp() {
        ...
        report2.setDescription("Compiled by Pradeesha");
    ...
    void testGetAllReports() {
        ...
        assertTrue(result.get(1).getDescription().contains("Pradeesha"));
    }
    ...
    void testUpdateReport() {
        ...
        assertTrue(result.getDescription().contains("Pradeesha"));
    }
